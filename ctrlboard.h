...
typedef enum
{
    ...
    EXTERNAL_UART_TX,  ///< Show message
    EXTERNAL_UART_UPLOAD_RX,  ///串口上行数据接收
    EXTERNAL_UART_DEV_INFO_RX,
    EXTERNAL_UART_SYNC_DATA_RX,
    EXTERNAL_UART_FACTORY_TEST_RX,
    EXTERNAL_UART_RESET_RX,
